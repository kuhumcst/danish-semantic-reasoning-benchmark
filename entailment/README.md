...
- Finally, information is given regarding which frame was used for the act/event. 
...
Data is derived from [the Danish FrameNet Lexicon](https://korpus.dsl.dk/resources/details/framenet.html). To cite, please use the following citation:

Sanni Nimb. 2018. [The Danish FrameNet Lexicon: method and lexical coverage](https://lrec-conf.org/workshops/lrec2018/W5/pdf/3_W5.pdf). 
In *Proceedings of the Eleventh International Conference on Language Resources and Evaluation (LREC 2018)*, Paris, France. European Language Resources Association (ELRA).
...
In this first version of the dataset, we have focused on frames that refer to causative events on more or less concrete items, where the result of the event is relatively unambiguous. 
